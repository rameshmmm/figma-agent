...
async function handleCommand(command, params) {
  switch (command) {
    ...
    case "get_frames":
      console.log("get_frames called");
      return await getAllFrames();
    case "get_frame":
      return await getFrame(params.name);
    default:
      console.log("unknown cmd called");
...
async function getAllFrames() {
  ...
  console.log("Hello from getAllFrames", figma.root.findAll(n => n.type === 'FRAME'));
  return figma.root.findAll(n => n.type === 'FRAME');
}

async function getFrame(name) {
  await figma.loadAllPagesAsync()
  return figma.root.findOne(n => n.type === 'FRAME' && n.name === name);
}
